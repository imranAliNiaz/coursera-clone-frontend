...
import type { NavItem } from "../../types/ui/admin/layout.types";
...
const AdminLayout: React.FC = () => {
  ...
  const SidebarContent: React.FC = () => (
    <div className="flex flex-col h-full bg-surface border-r border-border shadow-sm">
      ...
      <div className="p-4 border-t border-border">
        <div className="bg-gradient-to-br from-primary/5 to-surface p-4 rounded-xl border border-primary/10 shadow-sm">
          ...
          <button className="w-full py-2.5 px-4 rounded-lg bg-surface border border-border text-xs font-semibold text-text-secondary hover:bg-surface-hover hover:border-border-dark transition-all duration-200 shadow-sm">
            End Session
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex min-h-screen bg-background font-sans antialiased">
      ...
      <aside
        className={`fixed inset-y-0 left-0 w-72 z-50 lg:hidden bg-surface shadow-2xl transition-transform duration-300 ease-in-out ${
      ...
      <main className="flex-1 lg:ml-72 min-h-screen flex flex-col">
        <header className="sticky top-0 z-30 bg-surface/95 backdrop-blur-md border-b border-border shadow-sm">
          <div className="px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex items-center bg-background rounded-lg px-4 py-2.5 border border-border group focus-within:bg-surface focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                <svg
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="bg-transparent border-none text-sm px-0 focus:outline-none text-text-primary placeholder:text-text-muted w-48 font-medium"
                />
              </div>
